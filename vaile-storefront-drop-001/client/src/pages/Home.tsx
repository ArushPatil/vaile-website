...
export default function Home() {
  ...
  return <>
    ...
    <motion.main className={isLoading ? "site-shell is-loading" : "site-shell"} initial={{ opacity: 0 }} animate={{ opacity: isLoading ? 0 : 1 }} transition={{ duration: 0.45, ease: [0.23, 1, 0.32, 1] }}>
      ...
      <ScrollScene><section className="construction construction--dark"><div className="construction__image-wrap detail-inspector torn-image"><img src={assets.closeOne} alt="Close-up of black canvas fabric, belt loop and copper rivet" className="construction__primary-image" /><div className="image-tag image-tag--dark image-tag--magnetic"><span>FIG. 02</span><span>HARDWARE / DETAIL</span></div><span className="detail-inspector__cue" aria-hidden="true">INSPECT</span></div><div className="construction__story"><Reveal><SectionLabel index="04" label="CONSTRUCTION" dark /></Reveal><Reveal delay={0.08}><h2>Where it<br /><em>counts.</em></h2></Reveal><Reveal delay={0.14}><div className="construction__items"><article><span>01</span><div><h3>Heavy canvas</h3><p>Dense 12oz cotton gives the silhouette structure from the first wear.</p></div></article><article><span>02</span><div><h3>Rivet set</h3><p>Cairn-toned hardware cues anchor high-stress points.</p></div></article><article><span>03</span><div><h3>Utility pockets</h3><p>Layered pockets and a relaxed leg keep the design working after the photo ends.</p></div></article></div></Reveal></div></section></ScrollScene>
