...
const shots = [
  { id: "01", title: "FRONT PROFILE", insight: "A relaxed straight leg. Enough room to move, enough structure to hold its line. Designed to wear in, not pose in.", desktop: "/images/1-desktop.jpg", mobile: "/images/1-mobile.jpg", alt: "VAILE Drop 001 black duck canvas pants front full standing view" },
  { id: "02", title: "LATERAL DRAPE", insight: "Wear true to size for an easy fit. The side profile maintains a clean, straight fall with a natural break over the shoe.", desktop: "/images/2-desktop.jpg", mobile: "/images/2-mobile.jpg", alt: "VAILE Drop 001 black duck canvas pants side profile view" },
  { id: "03", title: "HARDWARE & POCKETS", insight: "Dense 12oz duck canvas with layered storage. Rivet hardware anchors the high-stress points without breaking the line of the leg.", desktop: "/images/3-desktop.jpg", mobile: "/images/3-mobile.jpg", alt: "VAILE Drop 001 canvas pocket and rivet hardware" },
  { id: "04", title: "FIELD STRIDE", insight: "The uniform gets better with use. The heavy canvas earns character slowly, starting stable and softening at flex points.", desktop: "/images/10_warm-desktop.jpg", mobile: "/images/10_warm-mobile.jpg", alt: "VAILE Drop 001 black duck canvas pants field movement view" },
  { id: "05", title: "SEATED BREAK", insight: "Size up for extra room through the seat and thigh. The pattern is engineered to prevent restriction during heavy movement.", desktop: "/images/6-desktop.jpg", mobile: "/images/6-mobile.jpg", alt: "VAILE Drop 001 seated canvas break" },
  { id: "06", title: "STRIDE IN MOTION", insight: "Clear over a shoe. The hem width is calibrated to fall naturally across boots and sneakers alike, avoiding artificial taper.", desktop: "/images/9-desktop.jpg", mobile: "/images/9-mobile.jpg", alt: "VAILE Drop 001 walking silhouette" },
];
