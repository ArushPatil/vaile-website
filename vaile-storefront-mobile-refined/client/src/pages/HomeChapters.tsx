...
const shots = [
  { id: "01", title: "FRONT PROFILE", proof: "SILHOUETTE", detail: "Relaxed straight leg / natural break", insight: "Enough room to move, enough structure to hold its line. Designed to wear in, not pose in.", desktop: "/images/1.webp", mobile: "/manus-storage/vaile-lookbook-01-mobile_425878b5.webp", alt: "VAILE Drop 001 black duck canvas pants front full standing view" },
  { id: "02", title: "LATERAL DRAPE", proof: "FIT", detail: "Wear true to size / clean side fall", insight: "The side profile maintains a steady fall through the leg with room to move and a clean break over the shoe.", desktop: "/images/2.webp", mobile: "/manus-storage/vaile-lookbook-02-mobile_7c15e956.webp", alt: "VAILE Drop 001 black duck canvas pants side profile view" },
  { id: "03", title: "HARDWARE & POCKETS", proof: "CONSTRUCTION", detail: "Layered storage / reinforced stress points", insight: "Dense 12oz duck canvas and rivet hardware give the utility pockets structure without breaking the line of the trouser.", desktop: "/images/3.webp", mobile: "/manus-storage/vaile-lookbook-03-mobile_61d8b113.webp", alt: "VAILE Drop 001 canvas pocket and rivet hardware" },
  { id: "04", title: "FIELD STRIDE", proof: "MATERIAL", detail: "12oz duck canvas / character through wear", insight: "The canvas begins stable, then softens gradually at the flex points. It earns character through use rather than surface treatment.", desktop: "/images/10_warm.webp", mobile: "/manus-storage/vaile-lookbook-04-mobile_a5a4c329.webp", alt: "VAILE Drop 001 black duck canvas pants field movement view" },
  { id: "05", title: "SEATED BREAK", proof: "MOBILITY", detail: "Seat and thigh room / no forced sizing up", insight: "The pattern holds comfort through the seat and thigh during long wear without asking you to size up for movement.", desktop: "/images/6.webp", mobile: "/manus-storage/vaile-lookbook-05-mobile_d4406475.webp", alt: "VAILE Drop 001 seated canvas break" },
  { id: "06", title: "STRIDE IN MOTION", proof: "HEM", detail: "Clear over footwear / no artificial taper", insight: "The hem is calibrated to fall naturally across boots and sneakers, retaining a clear opening without collapsing around the shoe.", desktop: "/images/9.webp", mobile: "/manus-storage/vaile-lookbook-06-mobile_c7a7956b.webp", alt: "VAILE Drop 001 walking silhouette" },
];
